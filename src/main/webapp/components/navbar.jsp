...
<%
         ...
         TypeDaoImp cdao=new TypeDaoImp();
         List<Type> cll=cdao.getAllType();
%>

<nav class="navbar navbar-expand-lg navbar-light bg-light">

<div class="container-fluid">
  <a class="navbar-brand" href="index.jsp"><img src="images/shopware-logo.png" height="50px" width="180px" alt="shopware logo"/></a>
    ...
    %>
      <li class="nav-item active dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="index.jsp?brand=0" >All</a>
               <%
                    for(Brand c: cl)
                    {    	
               %> 
                         <a class="dropdown-item" href="index.jsp?brand=<%=c.getBrandId() %>"><%=c.getBrandTitle() %></a>
               <%
                    }
               %>
      ...
      <li class="nav-item active dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="index.jsp?type=0" >All</a>
               <%
                    for(Type c: cll)
                    {    	
               %> 
                         <a class="dropdown-item" href="index.jsp?type=<%=c.getTypeId() %>"><%=c.getTypeTitle() %></a>
               <%
                    }
               %>
          ...
          <ul class="navbar-nav ml-auto">
              ...
              %>
                     <li class="nav-item active" data-toggle="modal" data-target="#showmycartmodal">
                        <div class="nav-link"><img class="custom-bg" src="images/cart.png" style="width:23px;" alt="img"><% if(new CartDaoImp().totalCartByUserId(user.getUserId())!=0){} %> <%=new CartDaoImp().totalCartByUserId(user.getUserId()) %></div>
                     </li> 
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
         ...
         <div class="container text-center">
                   <img style="max-width:200px" class="img-fluid rounded-circle" src="data:image/jpeg;base64,<%if(user!=null){ %><%=user.getUserPicInBase() %><%} %>" alt="users_pic" >
         </div> 
  ...
  <tbody>
   ...
   %>
    <tr class="text-center">
      <td><img style="max-height:100px;max-width:70px;width:auto;" class="img-fluid mx-auto d-block" src="data:image/jpeg;base64,<%=p.getProductPicInBase()  %>"  alt="users_pic" ></td>
