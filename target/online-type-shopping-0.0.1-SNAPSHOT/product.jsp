...
//     String productFor=product.getProductFor();
     List<Product> lop=new ProductDaoImp().getProductByBrandAndFor( typeId);
%>
...
<div class="container-fluid">
  ...
  <button type="submit" class="btn custom-bg" style="width:200px;">Search</button>
        ...
        <div class="col-sm-3 mt-4 admin">
              <div class="card">
                   <img src="data:image/jpeg;base64,<%=product.getProductPicInBase() %>" style="max-height:500px;max-width:100%;width:auto;" class="card-img-top rounded mx-auto d-block m-2" alt="img">
              </div>
        </div>
        ...
        <div class="col-sm-6 mt-4 admin">
              <div class="card">
                   <div class="card-header text-center">
                        <h3 class="text-muted text-left ml-4">Brand: <%=new BrandDaoImp().getBrandNameById(product.getBrandId()) %> (<%=new TypeDaoImp().getTypeNameById(product.getTypeId()) %>)</h3>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
     ...
     <div class="container text-center">
                   <img style="max-width:200px" class="img-fluid" src="data:image/jpeg;base64,<%=product.getProductPicInBase()  %>" alt="users_pic" >
<%--                   <h3><%=product.getProductPicInBase()  %></h3>--%>
         </div> 
