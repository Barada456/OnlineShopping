    ...
    <div class="row mt-3">
        <div class="col-md-3">
            <div class="card hover" data-toggle="modal" data-target="#show-users-modal">
                <div class="card-body text-center">
                    <div class="container">
                        <img style="max-width:120px" class="img-fluid rounded-circle" src="images/totalUser.jpg"
                             alt="users_pic">
                    </div>
        ...
        <div class="col-md-3">
            <div class="card hover" data-toggle="modal" data-target="#show-category-modal">
                <div class="card-body text-center">
                    <div class="container">
                        <img style="max-width:120px" class="img-fluid rounded-circle" src="images/brand.jpg"
                             alt="users_pic">
                    </div>
        ...
        <div class="col-md-3">
            <div class="card hover" data-toggle="modal" data-target="#show-cloth-modal">
                <div class="card-body text-center">
                    <div class="container">
                        <img style="max-width:120px" class="img-fluid rounded-circle" src="images/cloth.jpg"
                             alt="users_pic">
                    </div>
                    <h1><%=new ClothDaoImp().getTotalCloth() %>
                    </h1>
        ...
        <div class="col-md-3">
            <div class="card hover" data-toggle="modal" data-target="#show-product-modal">
                <div class="card-body text-center">
                    <div class="container">
                        <img style="max-width:120px" class="img-fluid rounded-circle" src="images/products.jpg"
                             alt="users_pic">
                    </div>
    ...
    <div class="row mt-3">
        <div class="col-md-3">
            <div class="card hover" data-toggle="modal" data-target="#total-order-modal">
                <div class="card-body text-center">
                    <div class="container">
                        <img style="max-width:120px" class="img-fluid rounded-circle" src="images/orders.jpg"
                             alt="users_pic">
                    </div>
            ...
            <div class="card hover" data-toggle="modal" data-target="#add-category-modal">
                <div class="card-body text-center">
                    <div class="container md-5">
                        <img style="max-width:120px" class="img-fluid rounded-circle" src="images/addbrand.jpg"
                             alt="users_pic">
                    </div>
        ...
        <div class="col-md-3">
            <div class="card hover" data-toggle="modal" data-target="#add-cloth-modal">
                <div class="card-body text-center">
                    <div class="container md-5">
                        <img style="max-width:120px" class="img-fluid rounded-circle" src="images/addcloth.jpg"
                             alt="users_pic">
                    </div>
        ...
        <div class="col-md-3">
            <div class="card hover" data-toggle="modal" data-target="#add-product-modal">
                <div class="card-body text-center">
                    <div class="container">
                        <img style="max-width:120px" class="img-fluid rounded-circle" src="images/addproduct.jpg"
                             alt="users_pic">
                    </div>
...
<div class="modal fade" id="add-category-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
     aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="ProductOperationServlet" method="post">
                    ...
                    <div class="form-group">
                        <textarea style="height:250px" class="form-control" name="categoryDescription"
...
<div class="modal fade" id="add-cloth-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
     aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header custom-bg text-white">
            ...
            <div class="modal-body">
                <form action="ProductOperationServlet" method="post">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="clothTitle" placeholder="Enter Cloth Title here"
                               required>
                    </div>

                    <div class="form-group">
                        <textarea style="height:250px" class="form-control" name="clothDescription"
                                  placeholder="Enter Cloth Description here" required></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        <select name="productClothId" class="form-control">
                            ...
                            <%
                                for (Cloth cloth : lic) {
                            %>
                            <option value="<%=cloth.getClothId()%>"><%=cloth.getClothTitle() %>
                            </option>
                            <%
                                }
                            %>
...
<div class="modal fade" id="show-category-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
     aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header custom-bg text-white text-center">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td class="mid-align"><a
                                    href="ProductOperationServlet?categoryId=<%=c.getBrandId()%>&action=deleteCategory"><input
...
<div class="modal fade" id="show-cloth-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
     aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header custom-bg text-white text-center">
            ...
            <div class="modal-body">
                <div class="table-responsive">
                    <table class="table">
                        ...
                        %>
                        <tr>
                            <td class="mid-align"><%=c.getClothId() %>
                            </td>
                            <td class="mid-align"><%=c.getClothTitle() %>
                            </td>
                            <td class="mid-align"><%=c.getClothDescription() %>
                            </td>
                            <td class="mid-align"><a
                                    href="ProductOperationServlet?clothId=<%=c.getClothId()%>&action=deleteCloth"><input
                                    type="submit" class="btn btn-danger" value="Delete"></a></td>
                        </tr>
                        <%
                            }
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td class="mid-align"><%=c.getBrandNameById(p.getCategoryId()) %>
                            </td>
                            <td class="mid-align"><%=new ClothDaoImp().getClothNameById(p.getClothId()) %>
                            </td>
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tr class="text-center">
                            ...
                            <td class="mid-align"><%= new BrandDaoImp().getBrandNameById(p1.getCategoryId()) %>
                            </td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="ProductOperationServlet" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <select name="productBrandId" class="form-control" >
                            <option value="<%=productForUpdate.getCategoryId() %>" selected>
                                <%
                                    int match = productForUpdate.getCategoryId();
                    ...
                    <div class="form-group">
                        <select name="productClothId" class="form-control">
                            <option value="<%=productForUpdate.getClothId() %>" selected>
                                <%
                                    int matchForCloth = productForUpdate.getCategoryId();
                                    peviousCloth = lic.stream()
                                            .filter(p ->p.getClothId() == matchForCloth)
                                            .collect(Collectors.toList()).get(0); %> <%=peviousCloth.getClothTitle()%></option>
                            <%
                                lic.removeIf(x -> x.getClothId() == matchForCloth);
